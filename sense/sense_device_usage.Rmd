...
```{r daily_frac_func, include = FALSE, eval = TRUE}
...
```{r cluster_plot_consum, eval = TRUE, fig.width=10, fig.height=3}
...
```{r cluster_functions_summed, include = FALSE, eval = TRUE}
