...
# function to run multiple test determining optimal cluster number
...
```{r}
home_001_cluster_df <- cluster_maker(c('heat 6','ac'))
cluster_tests(home_001_cluster_df)
cluster_plots(home_001_cluster_df,2)
cluster_plots(home_001_cluster_df,3)
