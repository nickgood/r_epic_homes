...
```{r daily_consum_functions, include = FALSE, eval = TRUE}
...
```{r daily_consum_overview, eval = TRUE}
...
```{r cluster_plots, eval = TRUE, fig.width=10, fig.height=3}
...
# cluster.tests(cluster_df, 'pct')
cluster.plots(hm, cluster_df,3, 'pct')
cluster.plots(hm, cluster_df,3, 'consumption')
...
# cluster.tests(cluster_df)
cluster.plots(hm, cluster_df,2, 'pct')
cluster.plots(hm, cluster_df,2, 'consumption')
