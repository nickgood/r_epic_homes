...
```{r cluster_compare_function, eval = FALSE}
...
```{r cluster_compare_plots, eval = FALSE, fig.width=10, fig.height=5}
...
# Use Only Manual Clustering  

```{r cluster_manual_function, eval = TRUE}
...
```{r cluster_manual_plots, eval = TRUE, fig.width=10, fig.height=3}
...
# hm <- '010'
# # no ac (later enrollment), also no one heat that makes complete sense by itself...
# cluster.manual(hm, c('heat 2'))


# hm <- '011'
# # no ac (later enrollment)
# cluster.manual(hm, c('heat 6'))
