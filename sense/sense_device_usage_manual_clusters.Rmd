...
#label a set TRUE if it contains 6 or more consecutive shoulder days
    z <- y$values == 'shoulder' & y$lengths >= 8 
...
#   geom_hline(yintercept = seq(1,6)-0.5, color = 'grey')+
...
#   ylab('Home')+
#   theme_classic()+
#     # geom_vline(data = season_end_points,
#     #         aes(xintercept = shoulder_start))+
#     # geom_segment(data=season_end_points,
#     #              aes(x = shoulder_start, xend = shoulder_start,
#     #                  y = home, yend=home))
#           geom_segment(
#                  aes(x = shoulder_start, xend = shoulder_start,
#                      y = as.numeric(home)-0.5, yend=as.numeric(home)+0.5))
