...
## Tier 3 Homes
```{r plot_manual_cluster_tier3, eval = FALSE, fig.width=8, fig.height=1}
...
## Tier 2 Homes
```{r plot_manual_cluster_tier2, eval = FALSE, fig.width=8, fig.height=1}
...
## Tier 1 Homes
```{r plot_manual_cluster_tier1, eval = FALSE, fig.width=8, fig.height=1}
...
ggplot(a, aes(x = as.Date(dateday), y = home)) +
  # color data point by cluster
  geom_tile(aes(fill = energy_cluster))+
  scale_fill_manual(values = c('red', 'blue', 'darkgreen'),
                    breaks = c('heat', 'ac', 'shoulder'),
