...
test_data_005 <- home_005 %>%
  ...
  timeVariation(test_data_005, pollutant = "avg_wattage", ylab = "W", group = "sense_device_name")
...
test_data_009 <- home_009 %>%
  ...
  timeVariation(test_data_009, pollutant = "avg_wattage", ylab = "W", group = "sense_device_name")
  timeVariation(test_data_009, pollutant = "avg_wattage", ylab = "W")
```
...
test_data_008 <- home_008 %>%
  ...
  timeVariation(test_data_008, pollutant = "avg_wattage", ylab = "W", group = "sense_device_name")
  timeVariation(test_data_008, pollutant = "avg_wattage", ylab = "W")
```
