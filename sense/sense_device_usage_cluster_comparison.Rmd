...
```{r functions_pam_cluster, include = FALSE}
...
```{r plot_pam_cluster_fraction, fig.width=10, fig.height=3}
...
```{r plot_pam_cluster_consum, fig.width=10, fig.height=3}
...
```{r pam_cluster_df_maker_consum_summed}
...
```{r plot_pam_cluster_consum_summed, fig.width=10, fig.height=3}
...
```{r plots_cluster_compare, fig.width=10, fig.height=5}
