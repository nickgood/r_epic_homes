...
all.equal(test %>% select(-period_compare, -overlap), test_after)
...
write_rds(entropy_time_hourly_pdf_df, file =
            paste0('./csv_created_article/representativeness_data/rep_data_time_hourly_pdf',
                   ifelse(clust[1] %in% month.abb[1:12], '_month', ''),
                   '.rds'))
# make dated backup
write_rds(entropy_time_hourly_pdf_df, file =
            paste0('./csv_created_article/representativeness_data/rep_data_time_hourly_pdf_',
                   Sys.Date(),
                   ifelse(clust[1] %in% month.abb[1:12], '_month', ''),
                   '.rds'))
