...
data<- read_rds('./csv_created_article/omni_hourly_calibrated.rds') %>% rename('datetime' = datehour)%>% 
...
* (indoor rooms pooled, outdoor and garage not used)
```{r}
...
write_csv(cov_by_sensor_season, './csv_created_article/cov/cov_by_sensor_season.csv')
```
...
write_csv(cov_by_sensor, './csv_created_article/cov/cov_by_sensor.csv')
```
...
write_csv(cov_by_sensor, './csv_created_article/cov/cov_by_home.csv')
```
