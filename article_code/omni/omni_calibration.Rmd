---
title: "Calibrate Omni PM2.5 Data"
output:
  html_document:
    toc: true
    toc_float: true
...
```{r}
daily_energy_df <- read_csv('../sense/csv_created_sense_article/daily_energy_data_clustered.csv')
