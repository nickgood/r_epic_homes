...
data <- pm25 %>%
  ...
  mutate(pattern = paste("^omni.*", id_home, location, sep = "_"),
         files = map2("../output_thesis/omni", pattern, list.files, full.names = TRUE),
...
```{r}
files <- list.files("../data_thesis/filters/soot_scan_csv", full.names = TRUE, pattern = ".csv$")
...
```{r}
# write_rds(bc, paste0("../output_thesis/bc/bc_",
# Sys.Date(),".rds"))
# # make data and backup
# write_rds(pm25, paste0("../output_thesis/pm25/pm25.rds"))
# write_rds(pm25, paste0("../output_thesis/pm25/pm25_",
# Sys.Date(),".rds"))
