...
#                         sheet = "metadata")
grav_meta <- read_csv("../data_thesis/filters/gravimetric_metadata.csv")

meta <- read_rds("../output_thesis/upas/upas_summary.rds")

# upas_log <- read_sheet("1PnPjgbYWljb5oXoSCBqpJb2pi7gU0Kzre5lx4H-3i70",
#                        sheet = "upas", col_types = "c")
upas_log <- read_csv("../data_thesis/homes/instruments_deployed_upas.csv",
...
grav <- read_csv("../data_thesis/filters/gravimetric_data.csv",
                     col_types = cols(.default = 'c')) %>%
