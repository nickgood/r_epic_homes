...
```{r functions_diurnal_seasons}
    ...
    # plot without labels and such
    plot.diurnal.season <- function(dat, err_ribbon = TRUE) {
...
### Group 2 and 3
```{r plots_diurnal_seasons, fig.height=5, fig.width=8}
...
### Group 2
```{r plots_diurnal_seasons, fig.height=5, fig.width=5.5}
...
### Group 3
```{r plots_diurnal_seasons, fig.height=5, fig.width=6.5}
