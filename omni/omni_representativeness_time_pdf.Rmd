...
scaled.entropy.table.time.pdf <- function(
  home_num, metric,
...
# start <- Sys.time()
# 
# test<- scaled.entropy.table.time.pdf('004', 'pm25',
# 
...
kld_max_df <- read_csv('./csv_created/representativeness_data/kld_max_time.csv')
...
entropy_time_test2 <- read_csv(file = './csv_created/representativeness_data/rep_data_time.csv')
