  ...
  summarise(mean = mean(get(metric)), sd = sd(get(metric)), n = n(),
    ...
    kld.period <- function(days) { # days = number of days in short samping period
      ...
      # return all calculated kld values
           ...
           'entire_hourly_n' = rep(entire_hourly_n, length(x[[1]])),
           'entire_hourly_sd' = rep(entire_hourly_sd, length(x[[1]]))
              )
            })
      ...
      function (
        ...
        map(a, function(x){
          ...
          list(
           ...
           'entire_hourly_n' = x['entire_hourly_n'],
           'entire_hourly_sd' = x['entire_hourly_sd'],
