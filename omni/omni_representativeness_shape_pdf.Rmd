...
{
a_data <- lapply(homes_all, function(x_home) {
...
# need to add kit_heat and bed_ac
# just define them as a_data and b_data without assigning!!!!!!!!
entropy_shape_pdf_df <- bind_rows(
  # pm25_bedroom_heat_rep_data_shape_pdf, # actually liv_heat  
  pm25_living_heat_rep_data_shape_pdf,
  # pm25_kitchen_heat_rep_data_shape_pdf, # actually liv_heat 
