...
# function to calculate scaled entropy for a house
# during multiple different time periods
kld.max <- function(home_num, metric,
...
# write_csv(kld_max_df, paste0('./csv_created/representativeness_data/kld_max_shape_pdf_',
#                     Sys.Date(), '.csv'))
...
kld_max_df <- read_csv('./csv_created/representativeness_data/kld_max_shape.csv')
