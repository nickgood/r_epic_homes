...
```{r plot_rep_rooms, fig.width = 8, fig.height = 3}

represent_df$metric <- factor(represent_df$metric, levels = c('pm25', 'voc', 'co2'))
...
# order homes by increasing metric value
