      ...
      lapply(locations_indoor, function(x_location) {
        ...
        lapply(metrics_all, function(x_metric) {
          ...
          lapply(homes_avail, function(x_home) {
            ...
            acf.grid(title = paste(x_location, x_metric, 'no clusters'), ncol = 4)
        }
        )
      }
      )
...
## for some homes, acf stops decreasing, likely due to non-stationarity of data
