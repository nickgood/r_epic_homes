...
```{r test_ggacf_data_resolution_affect, eval = FALSE}
...
acf.grid <- function(plots, title,
  ...
  do.call('grid.arrange', c(plots, top = title,
                            ncol = ncol))
...
```{r ggacf_grid_plots_no_clusters}
...
```{r ggacf_grid_plots_with_clusters}
