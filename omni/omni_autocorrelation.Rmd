...
#plot
  g <- ggplot(d.acf, aes(x=lag, y=acf)) +
    ...
    geom_line(data = lag_counts, aes(lag, qnorm((1 - ci) / 2) / sqrt(n_lag)),
...
ggacf(avg_test_data, '003', 'living', 10, 'pm25')

lapply(all_homes, ggacf,
       data = avg_test_data, loc = 'living', lag.max = 10, metric = 'pm25')
