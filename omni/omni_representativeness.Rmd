...
na.result <- function(sample_length, season, sample_available) {
  tibble(
  'coeff' = NA,
  'high_val' = NA,
  'low_val' = NA,
  ...
  'n_samp_avail' = sample_available # amount of samples with sufficient data
)
}
```
...
if(season_data_avail < 0.75) stop(paste(location_type,home_num, ' missing ',
...
if(year_data_avail < 0.75) stop(paste(location_type,home_num, ' missing ',
