...
write_csv(b, './csv_created/averages/pooled_home-pooled_rooms-avg.csv')
...
# write_csv(b, './csv_created/cov/all_home-pooled_rooms-cov.csv')
write_csv(b, paste0('./csv_created/cov/all_home-pooled_rooms-cov_', Sys.Date(),
'.csv'))
...
# write_csv(b, './csv_created/cov/pooled_home-pooled_rooms-cov.csv')

write_csv(b, paste0('./csv_created/cov/pooled_home-pooled_rooms-cov_', Sys.Date(),
'.csv'))

# by season, pooled homes
...
b <- a %>%
  select( metric, energy_cluster, everything(.)) %>%
  arrange( metric)


write_csv(b, './csv_created/cov/seasons-cov.csv')
write_csv(b, paste0('./csv_created/cov/seasons-cov_',
Sys.Date(), '.csv'))
