...
pattern <- paste0(".*omni_.*.rds$")
files <- list.files(paste0("./csv_created/omni_clean/omni_raw_", folder_date),
...
write_rds(a, paste0('./csv_created/pre-calibration/omni_all_locations_',
                       Sys.Date(), '.rds'))
