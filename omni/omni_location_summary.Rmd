...
# Make CSVs of data at different resolutions
...
write_csv(data, paste0('./csv_created/omni_clean/omni_', id_home, '_', location,
                       '.csv'))
}
...
write_csv(a, paste0('./csv_created/omni_clean/omni_all_locations_',
                       Sys.Date(), '.csv'))
...
omni_data <- read_csv(paste0('./csv_created/omni_all_locations.csv'))
```
