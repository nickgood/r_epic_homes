...
### All homes, (One Room)
```{r plot_rep_deviation_boxplot, fig.height=7, fig.width = 10.5, eval = FALSE}
...
coeff <- 1
    ...
    ylab(rep_measure)+
        ggtitle(label = paste(
                               ...
                               threshold, '% of overall', met, dependent,
...
```{r plot_rep_deviation_fraction_samples, fig.height=7, fig.width = 10.5}
