    ...
    mutual_info_rooms <- 
      map(rooms_with_data,
          function(room){
            ...
            data_complement <- data_wide_complete_log %>% select(all_of(other_rooms))%>%
...
mutual_info_df <- read_csv('./csv_created/representativeness_data/mutual_info_new_var_2021-07-12.csv')
