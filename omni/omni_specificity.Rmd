...
var00 <- sd(data %>% pull(room))^2
cov01 <- cov(data %>% pull(room), data %>% pull(other_rooms[1]))
cov02 <- cov(data %>% pull(room), data %>% pull(other_rooms[2]))
cov10 <- cov(data %>% pull(other_rooms[1]), data %>% pull(room))
var11 <- sd(data %>% pull(other_rooms[1]))^2
cov12 <- cov(data %>% pull(other_rooms[1]),
             data %>% pull(other_rooms[2]))
cov20 <- cov(data %>% pull(other_rooms[2]),
             data %>% pull(room))
cov21 <- cov(data %>% pull(other_rooms[2]),
             data %>% pull(other_rooms[1]))
var22 <- sd(data %>% pull(other_rooms[2]))^2
}
